...
import type1 from "../../../image/Switch Games/Switch Super Mario Party.png"
    ...
    return(
        <div className="container-fluid">
          ...
          <Routes>
            ...
            <h4 className="nintendo p-5">Switch Mario Party (Mde/English)</h4>
            ...
            <Row className="mt-3">
              ...
              <div className="mt-5">
                <Container>
                  <Row >
                      <p>
                      Super-charged fun for friends and family—now with online play in board game mode and certain minigames!
