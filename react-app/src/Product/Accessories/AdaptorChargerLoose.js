...
import type1 from "../../image/Adaptor/Switch AC Adapter (Loose Pack) (1).jpeg";
import type2 from "../../image/Adaptor/Switch AC Adapter (Loose Pack) (2).jpeg";
...
import './AdaptorChargerLoose'
// import '../../Components/Home.css'

function AdaptorChargerLoose () {
    ...
    return(
        <div className="container-fluid">
          ...
          <Routes>
            ...
            <h4 className="nintendo p-5">Nintendo Switch AC Adapter/Adaptor [JPN] (Loose Pack)</h4>
            <Container fluid="sm">
...
export default AdaptorChargerLoose