...
import type1 from "../../image/JoyStick/Joy Con Charging Grip (1).jpeg";
import type2 from "../../image/JoyStick/Joy Con Charging Grip (2).jpeg";
...
import './ChargingGrip.css'
// import '../../Components/Home.css'

function ChargingGrip () {
    ...
    return(
        <div className="container-fluid">
          ...
          <Routes>
            ...
            <Row className="mt-3">
                <Col>
                <h1 className="ms-5">Rp 433,000</h1>
                </Col>
                <Col>
