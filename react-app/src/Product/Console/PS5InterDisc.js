...
export default function PS5InterDisc () {
        ...
        <div className="container-fluid">
          ...
          <Routes>
            ...
            <Carousel className="container text-center" variant="dark">
              ...
              <Row className="mt-3">
                <Col>
                <p className="ms-5"><s>Rp 12.999.000</s></p>
                <h1 className="ms-5">Rp 10,349,000</h1>
                </Col>
                <Col>
              ...
              <Container>
                  <Row >
                    ...
                    <ToggleButtonGroup type="checkbox" value={value} onChange={handleChange} vertical>
                      <NavLink className="btn btn-outline-secondary text-dark" id="tbg-btn-1" value={1} to="Product/Console/PS5InterDisc" active>
                        Inter Disc
                      </NavLink>
